...
interface LanguageSearchModel {
  keyword: string | null;
  locale: App.I18n.LangType | null;
  status: Api.Common.EnableStatus | null;
}

const model = defineModel<LanguageSearchModel>('model', { required: true });
...
<template>
  <NCard :bordered="false" size="small" class="card-wrapper">
    <NCollapse>
      <NCollapseItem :title="$t('common.search')" name="language-search">
        <NForm label-placement="top" :show-feedback="false">
          <NGrid responsive="screen" item-responsive>
            ...
            <NFormItemGi span="24 s:12 m:6" :label="$t('common.locale')" class="pr-24px">
              <NSelect
