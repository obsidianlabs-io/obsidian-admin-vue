const pageSection: Omit<App.I18n.Schema['page'], 'login'> = {
  dashboard: {
    branchDesc:
  ...
  audit: {
    ...
    logType: 'Log Type',
    logTypePlaceholder: 'Select log type',
    logTypeAll: 'All Logs',
    logTypeLogin: 'Login Logs',
    logTypeApi: 'API Logs',
    logTypeOperation: 'Operation Logs',
    logTypeData: 'Data Logs',
