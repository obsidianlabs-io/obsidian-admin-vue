...
import { type RouteAuthFilterContext, hasRouteAccess } from '@/store/modules/route/shared';
...
export function createRouteGuard(router: Router) {
  router.beforeEach(async (to, from, next) => {
    ...
    const routeAccessContext: RouteAuthFilterContext = {
    ...
    const hasAuth = hasRouteAccess({
      routeName: to.name || null,
      routeRoles: to.meta.roles,
      routePermissionCodes: to.meta.permissions,
